...
def run_stochas_sim():
    ...
    parser.add_argument("--root", type=int, default=2, help="Starting expression at the root")
    parser.add_argument("--n_genes", type=int, default=5, help="Number of genes to simulate")
    parser.add_argument("--sigma2", type=float, default=1, help="Variance for BM or OU")
    parser.add_argument("--optim", type=int, default=5, help="Optimal expression for OU")
    parser.add_argument("--alpha", type=float, default=1, help="Selective strength for OU")
    ...
    read_counts = simulate(tree, args.n_genes, args.root, args.test, args.optim, args.alpha, args.sigma2)
